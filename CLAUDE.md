...
- All Dependabot alerts resolved on 2026-05-12 via npm `overrides` in package.json (postcss `^8.5.10`, `@tootallnate/once` `^3.0.1`). Revisit when bumping `firebase-admin` to v13 — overrides may become unnecessary.
